<?php
	...
	// Preview options
	$mcImageManagerConfig['preview.wwwroot'] = $_SESSION['tinymce_public_path']; // absolute or relative from this script path, try to leave blank system figures it out.
	...
	// Path par defaut quand il n'y a aucune option de set dans l'appel direct de l'image manager
	$mcImageManagerConfig['filesystem.path'] = $_SESSION['tinymce_ressource_folder']; // absolute or relative from this script path, optional.
		
	//Path à browser par l'image manager
	$mcImageManagerConfig['filesystem.rootpath'] = $_SESSION['tinymce_ressource_folder']; // absolute or relative from this script path, optional.
	
	//die($mcImageManagerConfig['filesystem.rootpath']);
	...
	$mcImageManagerConfig['filesystem.directory_templates'] = 'templates/directory,templates/another_directory';
	...
	$mcImageManagerConfig['authenticator.login_page'] = "../../../../administration/login/";
